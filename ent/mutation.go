...
func (m *AttendanceMutation) SetIDUser(s string) {
	m.id_user = &s
}

// IDUser returns the value of the "id_user" field in the mutation.
func (m *AttendanceMutation) IDUser() (r string, exists bool) {
	v := m.id_user
	if v == nil {
		return
	}
...
// OldIDUser returns the old "id_user" field's value of the Attendance entity.
// If the Attendance object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AttendanceMutation) OldIDUser(ctx context.Context) (v string, err error) {
...
func (m *AttendanceMutation) ResetIDUser() {
	m.id_user = nil
}

// SetType sets the "type" field.
func (m *AttendanceMutation) SetType(i int) {
	m._type = &i
	m.add_type = nil
}

// GetType returns the value of the "type" field in the mutation.
func (m *AttendanceMutation) GetType() (r int, exists bool) {
	v := m._type
	if v == nil {
		return
	}
...
// OldType returns the old "type" field's value of the Attendance entity.
// If the Attendance object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AttendanceMutation) OldType(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AttendanceMutation) AddType(i int) {
	if m.add_type != nil {
		*m.add_type += i
	} else {
		m.add_type = &i
...
func (m *AttendanceMutation) AddedType() (r int, exists bool) {
	v := m.add_type
	if v == nil {
		return
	}
...
func (m *AttendanceMutation) ResetType() {
	m._type = nil
	m.add_type = nil
}
...
func (m *AttendanceMutation) Fields() []string {
	...
	if m.id_user != nil {
		fields = append(fields, attendance.FieldIDUser)
	}
	if m._type != nil {
		fields = append(fields, attendance.FieldType)
	}
	if m.created_at != nil {
